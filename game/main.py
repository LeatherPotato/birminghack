...
def gameLoop():
    ...
    #state2
    char1 = CharSelect(-200,0,150,150,'flash_pics/flash.png','names_pics/flashname.png','Flash')
    char2 = CharSelect(0,0,150,150,'buzz_pics/buzz.png','names_pics/buzzname.png','Buzz')
    char3 = CharSelect(200,0,150,150,'sensor_pics/sensor.png','names_pics/sensorname.png','Sensor')
    ...
    timerTxt = Button(140,32,(255,255,255),'100',base_font)
